...
/**
   ...
   $total = array_merge($locais, $hotelaria);  
        ...
        $retorno .= '<div class="row font hotel" style="background-color: '.$options['cor_fundo_texto'].';min-height: 100px;padding-top: 20px;">
...
if($chechbox_motor == "on"){ }else{
     $retorno .= '<div class="col-lg-4 col-xs-12" style="padding: 0;border: 3px solid '.$options['cor_bordas'].';">
     ...
     $retorno .= '<div class="'.($chechbox_motor == "on" ? "col-lg-3" : "col-lg-2").' col-xs-12" style="box-shadow: 0px 0px 7px #888585;padding: 0;border: 3px solid '.$options['cor_bordas'].';">
<div class="input-group" style="height:45px;border-radius: 0;">
  <div class="input-group-prepend">
    <span class="input-group-text" id="basic-addon1" style="
    background-color: #fff;
...
">Necessário informar a data.</p>
    ...
    <div class="col-lg-4 col-xs-12" style="box-shadow: 0px 0px 7px #888585;padding: 0;border: 3px solid '.$options['cor_bordas'].';">
...
<option value="17">17 anos de idade</option> 
    ...
    <div class="col-lg-2 col-xs-12" style="box-shadow: 0px 0px 7px #888585;padding: 0;border: 3px solid '.$options['cor_bordas'].';">
